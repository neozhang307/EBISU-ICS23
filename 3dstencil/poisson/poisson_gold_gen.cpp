  ...
  for (int l_h = 0; l_h < height-0; l_h++)
    for (int l_y = 0; l_y < width_y-0; l_y++)
      for (int l_x = 0; l_x < width_x-0; l_x++) {
        ...
        output[l_h][l_y][l_x] =  2.666f * input[l_h][l_y][l_x] 
        - 
              0.166f*(input[b0][l_y][l_x]+input[t0][l_y][l_x]+input[l_h][s0][l_x]+input[l_h][n0][l_x]+input[l_h][l_y][e0]+input[l_h][l_y][w0])
              -
              0.0833f*(input[b0][s0][l_x]+input[b0][n0][l_x]+input[t0][s0][l_x]+input[t0][n0][l_x]+
                      input[b0][l_y][w0]+input[b0][l_y][e0]+input[t0][l_y][w0]+input[t0][l_y][e0]+
                      input[l_h][s0][w0]+input[l_h][s0][e0]+input[l_h][n0][w0]+input[l_h][n0][e0]
                );
      //   // 1.51*input[l_h][l_y][l_x]/159;
      //       (
      //           0.50*(input[b0][s0][w0] + input[b0][s0][e0] + input[b0][n0][w0] + input[b0][n0][e0]) +
      ...
      //           0.52*(input[t0][s0][w0] + input[t0][s0][e0] + input[t0][n0][w0] + input[t0][n0][e0])
      //       ) 
      //       / 159;
      }
}
